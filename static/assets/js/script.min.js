...
$("bod").append(
  '<div class="fixed-button active"><a href="http://mosendev.rf.gd/" target="_blank" class="btn btn-md btn-primary"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Hello</a> </div>'
);
var $window = $(window),
  na = $(".-button");
